...
def Start(cooldown=True, cooldown_time=COOLDOWN):
...
unit_y = timer_y + 40
hrs = StringVar()
Entry(root, textvariable=hrs, width=2, font="arial 50", bg="#001", fg="#fff", bd=0).place(x=30, y=timer_y)
hrs.set("00")
mins = StringVar()
Entry(root, textvariable=mins, width=2, font="arial 50", bg="#001", fg="#fff", bd=0).place(x=150, y=timer_y)
mins.set("00")
secs = StringVar()
Entry(root, textvariable=secs, width=2, font="arial 50", bg="#001", fg="#fff", bd=0).place(x=270, y=timer_y)
secs.set("00")
...
buttonStart = Button(
    root, text="Start", bg="#ea3548", bd=0, fg="#fff", width=10, height=2, font="arial 10 bold", command=Start
)
buttonStop = Button(
    root, text="Stop", bg="#ea3548", bd=0, fg="#fff", width=10, height=2, font="arial 10 bold", command=Stop
)
buttonFocus = Button(
    root, text="Focus", bg="#ea3548", bd=0, fg="#fff", width=10, height=2, font="arial 10 bold", command=Focus
)
button_y = timer_y + 80
xs = [30, 155, 280]
